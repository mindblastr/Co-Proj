...
#
# Generated by Vivado on Fri Mar 02 15:37:31 WET 2018
...
compile()
{
  ...
  vlogan -work processing_system7_bfm_v2_0_5 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../lab0.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl" \
    "$ref_dir/../../../../lab0.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl/processing_system7_bfm_v2_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../lab0.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/miguel/Desktop/HW_SW/Labs/Lab0/lab0/lab0.cache/compile_simlib/vcs"
  fi
